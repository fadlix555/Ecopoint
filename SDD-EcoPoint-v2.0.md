...
+------------------+     +------------------+     +------------------+
        ...
        |-- UC-01 Daftar         |                        |
        |-- UC-02 Login ---------+------------------------+
        |-- UC-03 Setoran        |-- UC-06 Input Berat    |-- UC-08 Review
        |-- UC-04 Lihat Saldo    |-- UC-07 Tolak Setoran  |-- UC-09 Tambah Poin
        |-- UC-05 Ajukan Redeem  |-- UC-13 Inventori      |   (include UC-08)
                                 |-- UC-14 Jual Mitra     |-- UC-10 Harga
                                                          |-- UC-11 Setujui Redeem
                                                          |   (include UC-15)
                                                          |-- UC-12 Tolak Redeem

+------------------+                           +------------------+
|     <<actor>>    |                           |    <<actor>>     |
| Payment Gateway  |                           |      Mitra       |
+------------------+                           +------------------+
        |-- UC-15 Transfer                             |-- Menerima data
```
